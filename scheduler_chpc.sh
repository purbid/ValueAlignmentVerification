...
python3 model_test.py --filter_by_subset "safety" --shorten_size  768
...
#python3 removeRedundancy.py -grammaticality -model ./models/preference_model.pt -data ./models/val.json -loadFeats 
